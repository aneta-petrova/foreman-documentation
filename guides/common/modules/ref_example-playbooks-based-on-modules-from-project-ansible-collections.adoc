...
`vars_files`:: The name of the vault file that stores values for `username`, `password`, and `server_url`.
`module_defaults`:: The module defaults group that maps `username`, `password`, and `server_url` to the vault file.
