...
For more information, see {AdministeringDocURL}automating-{project-context}-management-with-{project-context}-ansible-collections[Automating {Project} management with {Project} Ansible Collections] in _{AdministeringDocTitle}_.
How will I recover in case of a disruptive event?:::
